...
__all__ = ["get_student_list_by_group","get_attendance","save_attendance","get_leave_applications","get_workspace_data", "get_sidebar", "login", "validate_token", "get_visitor_data","create_visitor","get_admission_enquiry","create_admission_enquiry","get_student_details", "get_enquiry_call_log","get_student_profile"]